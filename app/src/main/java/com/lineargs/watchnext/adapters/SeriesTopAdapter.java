...
public class SeriesTopAdapter extends BaseTabbedAdapter {
    ...
    private java.util.List<com.lineargs.watchnext.data.entity.TopRatedSerie> series;
    ...
    protected void bindViews(final TabbedViewHolder holder, final Context context, int position) {
        final com.lineargs.watchnext.data.entity.TopRatedSerie serie = series.get(position);
        ...
        holder.star.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = DataContract.TopRatedSerieEntry.buildSerieUriWithId(id);
                if (isFavorite(context, id)) {
    ...
    protected void onViewClick(View view, int position) {
        com.lineargs.watchnext.data.entity.TopRatedSerie serie = series.get(position);
        Uri uri = DataContract.TopRatedSerieEntry.buildSerieUriWithId(serie.getTmdbId());
    ...
    public void swapSeries(java.util.List<com.lineargs.watchnext.data.entity.TopRatedSerie> series) {
        this.series = series;
