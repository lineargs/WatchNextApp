...
public class TabbedSeriesActivity extends BaseTopActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
            Intent searchIntent = new Intent(this, SearchTVActivity.class)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return NavPopularSeriesFragment.newInstance();
                case 1:
                    return NavTopSeriesFragment.newInstance();
                case 2:
                    return NavOnTheAirSeriesFragment.newInstance();
                default:
                    return null;
            }
        }
