...
public class SerieTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction searchAutoComplete2 = onView(
                allOf(withId(R.id.search_src_text), withText("t"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete2.perform(replaceText("th"));

        ViewInteraction searchAutoComplete3 = onView(
                allOf(withId(R.id.search_src_text), withText("th"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete4 = onView(
                allOf(withId(R.id.search_src_text), withText("th"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete4.perform(replaceText("the"));

        ViewInteraction searchAutoComplete5 = onView(
                allOf(withId(R.id.search_src_text), withText("the"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete6 = onView(
                allOf(withId(R.id.search_src_text), withText("the"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete6.perform(replaceText("the "));
        ...
        ViewInteraction searchAutoComplete8 = onView(
                allOf(withId(R.id.search_src_text), withText("the "),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete8.perform(replaceText("the b"));

        ViewInteraction searchAutoComplete9 = onView(
                allOf(withId(R.id.search_src_text), withText("the b"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete14 = onView(
                allOf(withId(R.id.search_src_text), withText("the b"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete14.perform(replaceText("the bi"));

        ViewInteraction searchAutoComplete15 = onView(
                allOf(withId(R.id.search_src_text), withText("the bi"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete16 = onView(
                allOf(withId(R.id.search_src_text), withText("the bi"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete16.perform(replaceText("the big"));

        ViewInteraction searchAutoComplete17 = onView(
                allOf(withId(R.id.search_src_text), withText("the big"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
